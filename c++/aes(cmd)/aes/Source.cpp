...
void displayRoundStates(vector<RoundObject>&, int, CipherMode);
string preRoundFunction(string, string);
void roundFunction(CipherMode, RoundObject&, string, bool = true);
...
void displayRoundStates(vector<RoundObject> &roundStates, int blockNum, CipherMode mode)
{
	int roundNum = 0;
...
void roundFunction(CipherMode mode, RoundObject &roundObj, string roundKey, bool useMixCols)
{
