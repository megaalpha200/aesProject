function rotatedStr = rotWordLeft( word, offset )
%rotWordLeft Shifts every group of 2 hex values to the left by the amount
%offset
...
%   offset). A 1x8 shifted hex char vector is returned.
    ...
    rotatedStr = horzcat(rotatedStr, word(modOffsetVal+1:end));
    rotatedStr = horzcat(rotatedStr, word(1:modOffsetVal));
end
