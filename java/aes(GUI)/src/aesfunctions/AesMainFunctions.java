    ...
    public static String aesEncrypt(String plaintextHex, String initialKeyHex) {
        ...
        for (String block : plaintextBlocks) {
            ...
            for (int round = 1; round <= 10; round++) {
                ...
                debugOutput.append("Round " + round + " Key: " + roundKeys.get(round)).append(System.lineSeparator());
            ...
            debugOutput.append("For Block " + (blockNum + 1) + "...").append(System.lineSeparator());
            debugOutput.append("Block State: " + String.join(" ", StringManipulations.chunkString(block, 2))).append(System.lineSeparator());
